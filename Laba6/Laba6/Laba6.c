...
int main()
{
	...
	const char lastName[] = "Иванов";
	const char middleName[] = "Иванович";
	...
	initExamSubject(&subjects[2], "Высшая математика", "Лакерник", FOUR, 22, 01, 2018);
	initExamSubject(&subjects[3], "Философия", "Плужникова", FIVE, 29, 01, 2018);
	initExamSubject(&subjects[4], "АГиЛА", "Пискарёв", THREE, 17, 01, 2018);
